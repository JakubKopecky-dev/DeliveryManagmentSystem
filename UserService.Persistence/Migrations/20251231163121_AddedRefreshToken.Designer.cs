...
namespace UserService.Persistence.Migrations
{
    ...
    [Migration("20251231163121_AddedRefreshToken")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("UserService.Infrastructure.Identity.RefreshToken", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("UserService.Infrastructure.Identity.RefreshToken", b =>
                {
                    b.HasOne("UserService.Infrastructure.Identity.ApplicationUser", "User")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
